import { BaseSignInMessageSignerWalletAdapter, WalletAdapterNetwork, WalletName } from "@solana/wallet-adapter-base";
...
export const GoogleViaTipLinkWalletName =
    "Google via HyperlinkLink" as WalletName<"Google via TipLink">;
...
export enum EmbeddedWalletPage {
  ...
  type WalletAdapterConfig = {
    // Reach out to the TipLink team for a clientId
    clientId: string;
    title: string;
